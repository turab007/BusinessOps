...
@Component({
    selector: 'opportunity-status-dialog',
    templateUrl: 'opportunity-status-dialog.component.html',
})
export class OpportunityStatusDialogComponent {
    ...
    constructor(
        public dialogRef: MatDialogRef<OpportunityStatusDialogComponent>,
    ...
    ngOnInit() {
        try {
            ...
            if (this.pageAction == "view") {
                this.pageTitle = "View Opportunity Status";
                this.getData();
                this._disableForm(true);
            }
            else if (this.pageAction == "update") {
                this.pageTitle = "Edit Opportunity Status";
                this.getData();
                this._disableForm(false);
            }
            else if (this.pageAction == "create") {
                this.pageTitle = "Add new Opportunity Status";
                this._disableForm(false);
            }
        }
        catch (e) {
